			...
			<ul class="rslides callbacks callbacks1" id="slider4">
				<li>
					<div class="banner-top1">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>Alone we can do little, together we can do so much 
									<br>
				...
				<li>
					<div class="banner-top2">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>We provide needy with Food, Clothes, Gadgets, Vessels, Stationaries, Books.
	...
	<div class="blog-w3ls py-5" id="blog">
		<div class="container py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title text-white">Some of the Donars</h3>
				<span>
	...
	<div class="screen-w3ls py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				...
				<p class="mt-2">Avoid wastage Donate Excess to Needy People</p>
			</div>
			<div class="row">
            <div class="col-lg-6">
