...
<head>
    <title>Donate Excess Management System | Doantion Requerer </title>
    <!-- Meta tag Keywords -->
        ...
        <div class="py-xl-5 py-lg-3">
            ...
            <div class="d-flex">
                ...
                <div class="col-lg-7 contact-right-w3l">
                    <h5 class="title-w3 text-center mb-5"><h5 class="title-w3 text-center mb-5">Fill following form for donation request</h5></h5>
                    <form action="#" method="post">
                        ...
                        <div class="d-flex space-d-flex">
                            ...
                            <div class="form-group grid-inputs">
                                ...
                                <select  class="form-control" id="phone" name="brf">
                                    <option value="">Donation Required For</option>
                                    <option value="Father">Orphanage</option>
                                    <option value="Mother">Old Age Homes</option>
                                    <option value="Brother">Hunger Ones</option>
                                    <option value="Sister">Personal</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="10" cols="100" class="form-control" id="message" name="message" placeholder="Please enter why you require this donation" maxlength="999" style="resize:none"></textarea>
                        </div>
                        <div class="form-group">
